...
public enum ClassTypes {
	...
	ICYHOT(ChatColor.BLUE + "Half-Cold " + ChatColor.RED + "Half-Hot", Material.BLAZE_ROD,
			new String[] {ChatColor.DARK_GRAY + "Emitter", "", ChatColor.GRAY + "Use your ice and fire abilities",
					ChatColor.GRAY + "to damage your enemies and make",
					ChatColor.GRAY + "it harder for them to fight!", "", ChatColor.GRAY + "Make sure you keep yourself",
					ChatColor.GRAY + "at a balanced temperature!"},
			Games.QUIRK_BATTTLE, false, 4,0,0,0,false),
